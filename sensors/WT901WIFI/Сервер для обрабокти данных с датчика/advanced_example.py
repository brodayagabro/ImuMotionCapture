...
# Import sensor data
data = np.genfromtxt("/Users/venzoll/Study/Lab_mipt/WT901WiFi/WT901_filter/WT_sensor_data_20Hz_uT_modern_XY.csv", delimiter=",", skip_header=1)
...
ahrs.settings = imufusion.AhrsSettings(
    convention=imufusion.CONVENTION_ENU,   #NWU
    gain=0.5,
